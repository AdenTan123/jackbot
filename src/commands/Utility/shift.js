  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (sub === 'manage') {
        ...
        }[currentShift.status] || `${EMOJIS.cross} Off Duty`;
      ...
      return InteractionHelper.safeEditReply(interaction, { embeds: [errorEmbed('Shift Error', 'Failed to construct UI dashboard state.')] });
    }
  }
};